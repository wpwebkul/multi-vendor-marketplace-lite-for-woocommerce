...
/*!****************************************!*\
  !*** ./assets/build/front/js/front.js ***!
  \****************************************/
/**
 * Front End JS file.
 */
...
wkmp(function () {
  ...
  wkmp('.wkmp-table-responsive table tbody td input[type=checkbox]').on('click', function () {
    var checkedInput = wkmp('.wkmp-table-responsive table tbody td input[type=checkbox]:checked').length;
    var total = wkmp(".wkmp-table-responsive table tbody td input[type=checkbox]").length;
  ...
  wkmp(".wc-shipping-class-add").on("click", function (evt) {
    ...
    html += '<a href="#" class="wc-shipping-class-delete">' + wkmpObj.mkt_tr.mkt32 + '</a>';
    html += '</div>';
    html += '</div>';
      ...
      wkmp.ajax({
        ...
        success: function success(data) {
          ...
          if ('unauthorized' === data.success) {
            alert(wkmpObj.wkmp_authorize_error);
          }
          location.reload();
        }
      });
